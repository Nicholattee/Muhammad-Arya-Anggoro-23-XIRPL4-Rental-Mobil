...
if (isset($_POST["simpan_mobil"])) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"],$folderName)) {
        ...
        '$merk', '$jenis', '$warna', '$tahun_pembuatan', '$biaya_sewa_per_hari', 
        '$image')";
...
# untuk edit mobil
else if (isset($_POST["edit_mobil"])) {
    ...
    # jika update data dan gambar
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"],$folderName)) {
            ...
            '$image')";
                ...
                $sql = "update mobil set id_mobil='$id_mobil', nomor_mobil='$nomor_mobil',
                merk='$merk', jenis='$jenis', 
                warna='$warna', tahun_pembuatan='$tahun_pembuatan', biaya_sewa_per_hari='$biaya_sewa_per_hari', image='$image' where id_mobil='$id_mobil'";
            }
